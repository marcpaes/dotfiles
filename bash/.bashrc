...
# Configuração do GOROOT e PATH para Go usando asdf
go_path=$(asdf which go)
if [[ -n "$go_path" ]]; then
    export GOROOT=$(cd "$(dirname "$go_path")/../" && pwd)
...
# pnpm
export PNPM_HOME="/home/marcpaes/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
